...
<html lang="en">
    ...
    <body>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <form  class="p-5 bg-white">
                            <h4 class="text-black mb-5" style="text-align: justify">¡Complete los siguientes datos y nos contactaremos contigo!</h4> 
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label class="text-black" for="nombre_invitado_2">Nombre completo u empresa:</label>
                                    <input type="text" id="nombre_invitado_2" class="form-control" style="border-color: #8bc34a">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label class="text-black" for="correo_invitado_2">Correo:</label> 
                                    <input type="text" id="correo_invitado_2" class="form-control" style="border-color: #8bc34a">
                                </div>
                            </div>
        ...
        <a href="https://www.sofgem.cl/" class="py-5 d-block zoom" style="background: #8bc34a">
            <div class="container">
        ...
        <script>
            ...
            $("#boton_invitado_2").click(function (excepcion) {
                ...
                if (nombre_invitado_2 == "" || correo_invitado_2 == "") {
                    $('#validar').html("<b style='color: #990000'>Complete campo(s) vacio(s).</b>");
                } else {
                    if (validar_correo(correo_invitado_2)) {
                        $('#validar').html("<b style='color: #4caf50'>Datos enviados.</b>");
                    } else {
                        $('#validar').html("<b style='color: #990000'>Correo no valido</b>");
                    }
                }
            });
